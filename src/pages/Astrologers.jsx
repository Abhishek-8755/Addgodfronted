...
const Astrologers = () => {
  ...
  const sliderImages = [
    {
      id: 1,
      src: "assets/astrologer/astrologer1.png",
      alt: "Astrological Guidance",
    },
    {
      id: 2,
      src: "assets/astrologer/astrologer2.png",
      alt: "Horoscope Readings",
    },
    {
      id: 3,
      src: "assets/astrologer/astrologer3.png",
      alt: "Personalized Predictions",
    },
    {
      id: 4,
      src: "assets/astrologer/astrologer4.png",
      alt: "Astrology Consultation",
    },
    {
      id: 5,
      src: "assets/astrologer/astrologer5.png",
      alt: "Spiritual Insights",
    },
    {
      id: 6,
      src: "assets/astrologer/astrologer6.png",
      alt: "Astrological Solutions",
    },
  ];
    ...
    <div className="p-4">
      ...
      <section className="relative mb-6 bg-blue-50 p-6 rounded-lg shadow-lg">
        ...
        <div className="relative z-10">
          <h2 className="text-3xl font-bold text-blue-600 mb-4">Gameplan: Elevate Your Astrology Services!</h2>
          <p className="text-lg text-gray-700 mb-4">Discover innovative strategies to enhance your astrology business and captivate your audience:</p>
          <ul className="list-disc ml-8 space-y-4">
            <li className="text-lg text-gray-800">
              🔮 <strong>Personalized Predictions:</strong> Offer personalized horoscope readings to attract and retain clients.
            </li>
            <li className="text-lg text-gray-800">
      ...
      <section className="mb-6 bg-gradient-to-r from-green-50 to-blue-50 p-8 rounded-xl shadow-md">
        <h2 className="text-3xl font-extrabold text-green-600 mb-4">Boost Your Astrology Business with Digital Marketing!</h2>
        <p className="text-lg text-gray-700 mb-6">
          Transform your astrology business with these tailored digital strategies that drive engagement and build a lasting online presence.
        </p>
        <div className="space-y-6 ">
          ...
          <div className="p-4 border-l-4 border-yellow-400 bg-white shadow-sm rounded">
            ...
            <p className="text-gray-700">
              Use targeted keywords like “best astrologer near me” to ensure your business appears at the top of local search results.
            </p>
          </div>
      ...
      <section className="mb-6 bg-gradient-to-r from-purple-50 to-pink-50 p-8 rounded-xl shadow-md">
        ...
        <p className="text-lg text-gray-700 mb-4">
          Elevate your astrology business presence with creative and impactful social media strategies. Here’s how to connect and engage effectively:
        </p>
        <ul className="space-y-4">
          ...
          <li className="flex items-start">
            <span className="text-purple-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">
              Post captivating <strong>behind-the-scenes content</strong> showcasing your consultation process and client experiences.
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-purple-600 text-xl mr-2">✔</span>
      ...
      <section className="mb-6 bg-gradient-to-r from-green-50 to-yellow-50 p-8 rounded-xl shadow-md">
        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            ...
            <span className="text-gray-800">
              Create <strong>informative videos</strong> on astrology tips, horoscope readings, and client experiences to captivate viewers.
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-green-600 text-xl mr-2">✔</span>
          ...
          <li className="flex items-start">
            <span className="text-green-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">
              Promote astrology trends through quick, impactful reels on <strong>important topics</strong> like spiritual growth and personal
              development.
            </span>
          </li>
        </ul>
      ...
      <section className="mb-6 bg-gradient-to-r from-blue-50 to-teal-50 p-8 rounded-xl shadow-md">
        ...
        <p className="text-lg text-gray-700 mb-4">Monetize your astrology content and expand your reach with a thriving YouTube presence:</p>
        <ul className="space-y-4">
          <li className="flex items-start">
            <span className="text-blue-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">
              Share <strong>SEO-optimized content</strong> with valuable astrology tips, horoscope readings, and expert interviews.
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 text-xl mr-2">✔</span>
          ...
          <li className="flex items-start">
            <span className="text-blue-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">
              Collaborate with astrology influencers to grow an engaged audience and build a steady income stream.
            </span>
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6 bg-gradient-to-r from-red-50 to-orange-50 p-8 rounded-xl shadow-md">
        ...
        <p className="text-lg text-gray-700 mb-4">Protect and enhance your astrology brand’s reputation with these strategies:</p>
        <ul className="space-y-4">
          <li className="flex items-start">
          ...
          <li className="flex items-start">
            <span className="text-red-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">
              Collaborate with influencers to create <strong>astrology-related vlogs</strong> that resonate with your audience.
            </span>
          </li>
        </ul>
      </section>
      ...
      <section className="relative mb-6 bg-gradient-to-r from-teal-50 to-indigo-50 p-8 rounded-xl shadow-md">
        ...
        {/* Content Section */}
        <div className="relative z-10">
          <h2 className="text-3xl font-bold text-teal-600 mb-4">📱 Astrology App</h2>
          <p className="text-lg text-gray-700 mb-4">Revolutionize astrology services with cutting-edge digital solutions:</p>
          <ul className="space-y-4">
            <li className="flex items-start">
              <span className="text-teal-600 text-xl mr-2">✔</span>
              <span className="text-gray-800">
                Offer a <strong>user-friendly app</strong> to allow clients to easily book consultations and access personalized readings.
              </span>
            </li>
            <li className="flex items-start">
              <span className="text-teal-600 text-xl mr-2">✔</span>
              <span className="text-gray-800">
                Provide <strong>personalized notifications, consultation tracking, and automated communication</strong> for seamless service delivery.
              </span>
            </li>
            <li className="flex items-start">
              <span className="text-teal-600 text-xl mr-2">✔</span>
            ...
            <li className="flex items-start">
              <span className="text-teal-600 text-xl mr-2">✔</span>
              <span className="text-gray-800">
                Build <strong>virtual consultation rooms</strong> for convenient client interactions through video consultations.
              </span>
            </li>
          </ul>
        </div>
