...
const Groceries = () => {
  ...
  const sliderImages = [
    {
      id: 1,
      src: "assets/groceries/grocery1.png",
      alt: "Fresh Produce",
    },
    {
      id: 2,
      src: "assets/groceries/grocery2.png",
      alt: "Organic Products",
    },
    {
      id: 3,
      src: "assets/groceries/grocery3.png",
      alt: "Daily Essentials",
    },
    {
      id: 4,
      src: "assets/groceries/grocery4.png",
      alt: "Quality Groceries",
    },
    {
      id: 5,
      src: "assets/groceries/grocery5.png",
      alt: "Healthy Choices",
    },
    {
      id: 6,
      src: "assets/groceries/grocery6.png",
      alt: "Local Produce",
    },
  ];
    ...
    <div className="p-4">
      ...
      <section className="relative mb-6 bg-blue-50 p-6 rounded-lg shadow-lg">
        ...
        <div className="relative z-10">
          <h2 className="text-3xl font-bold text-blue-600 mb-4">Gameplan: Enhancing Your Grocery Business!</h2>
          <p className="text-lg text-gray-700 mb-4">Discover innovative strategies to enhance your grocery business and attract more customers:</p>
          <ul className="list-disc ml-8 space-y-4">
            <li className="text-lg text-gray-800">
              🥦 <strong>Fresh Produce:</strong> Ensure a continuous supply of fresh and high-quality produce.
            </li>
            <li className="text-lg text-gray-800">
              🌐 <strong>Online Ordering:</strong> Provide an easy-to-use online ordering system for customer convenience.
            </li>
            <li className="text-lg text-gray-800">
            ...
            <li className="text-lg text-gray-800">
              🔒 <strong>Quality Assurance:</strong> Ensure high-quality standards to build customer trust.
            </li>
            <li className="text-lg text-gray-800">
      ...
      <section className="mb-6 bg-gradient-to-r from-green-50 to-blue-50 p-8 rounded-xl shadow-md">
        <h2 className="text-3xl font-extrabold text-green-600 mb-4">Boost Your Grocery Business with Digital Marketing!</h2>
        <p className="text-lg text-gray-700 mb-6">
          Transform your grocery business with these tailored digital strategies that drive engagement and build a lasting online presence.
        </p>
        <div className="space-y-6 ">
          <div className="p-4 border-l-4 border-green-400 bg-white shadow-sm rounded">
            ...
            <p className="text-gray-700">
              Create a responsive, user-friendly platform to showcase your products, enable online sales, and provide essential information.
            </p>
          </div>
          ...
          <div className="p-4 border-l-4 border-yellow-400 bg-white shadow-sm rounded">
            ...
            <p className="text-gray-700">
              Use targeted keywords like “best grocery store near me” to ensure your store appears at the top of local search results.
            </p>
          </div>
      ...
      <section className="mb-6 bg-gradient-to-r from-purple-50 to-pink-50 p-8 rounded-xl shadow-md">
        ...
        <p className="text-lg text-gray-700 mb-4">
          Elevate your grocery business presence with creative and impactful social media strategies. Here’s how to connect and engage effectively:
        </p>
        <ul className="space-y-4">
          ...
          <li className="flex items-start">
            <span className="text-purple-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">
              Post captivating <strong>behind-the-scenes content</strong> showcasing your sourcing and quality control processes.
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-purple-600 text-xl mr-2">✔</span>
      ...
      <section className="mb-6 bg-gradient-to-r from-green-50 to-yellow-50 p-8 rounded-xl shadow-md">
        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            ...
            <span className="text-gray-800">
              Create <strong>informative videos</strong> on grocery shopping tips, product highlights, and healthy recipes to captivate viewers.
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-green-600 text-xl mr-2">✔</span>
          ...
          <li className="flex items-start">
            <span className="text-green-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">
              Promote grocery trends through quick, impactful reels on <strong>important topics</strong> like organic produce and sustainable
              packaging.
            </span>
          </li>
        </ul>
      ...
      <section className="mb-6 bg-gradient-to-r from-blue-50 to-teal-50 p-8 rounded-xl shadow-md">
        ...
        <p className="text-lg text-gray-700 mb-4">Monetize your grocery content and expand your reach with a thriving YouTube presence:</p>
        <ul className="space-y-4">
          <li className="flex items-start">
            <span className="text-blue-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">
              Share <strong>SEO-optimized content</strong> with valuable grocery tips, product reviews, and expert interviews.
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 text-xl mr-2">✔</span>
          ...
          <li className="flex items-start">
            <span className="text-blue-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">Collaborate with grocery influencers to grow an engaged audience and build a steady income stream.</span>
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6 bg-gradient-to-r from-red-50 to-orange-50 p-8 rounded-xl shadow-md">
        ...
        <p className="text-lg text-gray-700 mb-4">Protect and enhance your grocery brand’s reputation with these strategies:</p>
        <ul className="space-y-4">
          <li className="flex items-start">
          ...
          <li className="flex items-start">
            <span className="text-red-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">
              Collaborate with influencers to create <strong>grocery-related vlogs</strong> that resonate with your audience.
            </span>
          </li>
        </ul>
      </section>
      ...
      <section className="relative mb-6 bg-gradient-to-r from-teal-50 to-indigo-50 p-8 rounded-xl shadow-md">
        ...
        {/* Content Section */}
        <div className="relative z-10">
          <h2 className="text-3xl font-bold text-teal-600 mb-4">📱 Grocery App</h2>
          <p className="text-lg text-gray-700 mb-4">Revolutionize grocery shopping with cutting-edge digital solutions:</p>
          <ul className="space-y-4">
            <li className="flex items-start">
              <span className="text-teal-600 text-xl mr-2">✔</span>
              <span className="text-gray-800">
                Offer a <strong>digital shopping list</strong> feature to allow customers to easily manage their grocery lists.
              </span>
            </li>
            <li className="flex items-start">
              <span className="text-teal-600 text-xl mr-2">✔</span>
              <span className="text-gray-800">
                Provide <strong>online ordering, delivery tracking, and automated communication</strong> for seamless service delivery.
              </span>
            </li>
            <li className="flex items-start">
              <span className="text-teal-600 text-xl mr-2">✔</span>
            ...
            <li className="flex items-start">
              <span className="text-teal-600 text-xl mr-2">✔</span>
              <span className="text-gray-800">
                Build <strong>virtual aisles</strong> for convenient customer interactions through video consultations.
              </span>
            </li>
          </ul>
        </div>
