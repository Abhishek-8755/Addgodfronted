...
const Jewelry = () => {
  ...
  const sliderImages = [
    {
      id: 1,
      src: "assets/jewelry/jewelry1.png",
      alt: "Exquisite Jewelry Designs",
    },
    {
      id: 2,
      src: "assets/jewelry/jewelry2.png",
      alt: "Timeless Elegance",
    },
    {
      id: 3,
      src: "assets/jewelry/jewelry3.png",
      alt: "Handcrafted Perfection",
    },
    {
      id: 4,
      src: "assets/jewelry/jewelry4.png",
      alt: "Luxury Collection",
    },
    {
      id: 5,
      src: "assets/jewelry/jewelry5.png",
      alt: "Unique Creations",
    },
    {
      id: 6,
      src: "assets/jewelry/jewelry6.png",
      alt: "Finest Materials",
    },
  ];
    ...
    <div className="p-4">
      ...
      <section className="relative mb-6 bg-blue-50 p-6 rounded-lg shadow-lg">
        ...
        <div className="relative z-10">
          <h2 className="text-3xl font-bold text-blue-600 mb-4">Gameplan: Elevate Your Jewelry Business!</h2>
          <p className="text-lg text-gray-700 mb-4">Discover innovative strategies to enhance your jewelry business and captivate your audience:</p>
          <ul className="list-disc ml-8 space-y-4">
            <li className="text-lg text-gray-800">
              💎 <strong>Unique Designs:</strong> Offer exclusive and unique jewelry designs to attract discerning customers.
            </li>
            <li className="text-lg text-gray-800">
            ...
            <li className="text-lg text-gray-800">
              🌍 <strong>Sustainable Practices:</strong> Adopt sustainable and ethical practices in sourcing and production.
            </li>
            <li className="text-lg text-gray-800">
      ...
      <section className="mb-6 bg-gradient-to-r from-green-50 to-blue-50 p-8 rounded-xl shadow-md">
        <h2 className="text-3xl font-extrabold text-green-600 mb-4">Boost Your Jewelry Business with Digital Marketing!</h2>
        <p className="text-lg text-gray-700 mb-6">
          Transform your jewelry business with these tailored digital strategies that drive engagement and build a lasting online presence.
        </p>
        <div className="space-y-6 ">
          <div className="p-4 border-l-4 border-green-400 bg-white shadow-sm rounded">
            ...
            <p className="text-gray-700">
              Create a responsive, visually stunning platform to showcase your jewelry collections, enable online sales, and provide essential
              information.
            </p>
          </div>
          ...
          <div className="p-4 border-l-4 border-yellow-400 bg-white shadow-sm rounded">
            ...
            <p className="text-gray-700">
              Use targeted keywords like “best jewelry near me” to ensure your store appears at the top of local search results.
            </p>
          </div>
      ...
      <section className="mb-6 bg-gradient-to-r from-purple-50 to-pink-50 p-8 rounded-xl shadow-md">
        ...
        <p className="text-lg text-gray-700 mb-4">
          Elevate your jewelry business presence with creative and impactful social media strategies. Here’s how to connect and engage effectively:
        </p>
      ...
      <section className="mb-6 bg-gradient-to-r from-green-50 to-yellow-50 p-8 rounded-xl shadow-md">
        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            ...
            <span className="text-gray-800">
              Create <strong>informative videos</strong> on jewelry care, styling tips, and new collections to captivate viewers.
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-green-600 text-xl mr-2">✔</span>
          ...
          <li className="flex items-start">
            <span className="text-green-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">
              Promote jewelry trends through quick, impactful reels on <strong>important topics</strong> like sustainable practices and ethical
              sourcing.
            </span>
          </li>
        </ul>
      ...
      <section className="mb-6 bg-gradient-to-r from-blue-50 to-teal-50 p-8 rounded-xl shadow-md">
        ...
        <p className="text-lg text-gray-700 mb-4">Monetize your jewelry content and expand your reach with a thriving YouTube presence:</p>
        <ul className="space-y-4">
          <li className="flex items-start">
            <span className="text-blue-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">
              Share <strong>SEO-optimized content</strong> with valuable jewelry tips, product reviews, and expert interviews.
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 text-xl mr-2">✔</span>
          ...
          <li className="flex items-start">
            <span className="text-blue-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">Collaborate with jewelry influencers to grow an engaged audience and build a steady income stream.</span>
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6 bg-gradient-to-r from-red-50 to-orange-50 p-8 rounded-xl shadow-md">
        ...
        <p className="text-lg text-gray-700 mb-4">Protect and enhance your jewelry brand’s reputation with these strategies:</p>
        <ul className="space-y-4">
          <li className="flex items-start">
          ...
          <li className="flex items-start">
            <span className="text-red-600 text-xl mr-2">✔</span>
            <span className="text-gray-800">
              Collaborate with influencers to create <strong>jewelry-related vlogs</strong> that resonate with your audience.
            </span>
          </li>
        </ul>
      </section>
      ...
      <section className="relative mb-6 bg-gradient-to-r from-teal-50 to-indigo-50 p-8 rounded-xl shadow-md">
        ...
        {/* Content Section */}
        <div className="relative z-10">
          <h2 className="text-3xl font-bold text-teal-600 mb-4">📱 Jewelry App</h2>
          <p className="text-lg text-gray-700 mb-4">Revolutionize jewelry shopping with cutting-edge digital solutions:</p>
          <ul className="space-y-4">
            <li className="flex items-start">
              <span className="text-teal-600 text-xl mr-2">✔</span>
              <span className="text-gray-800">
                Offer a <strong>virtual try-on feature</strong> to allow customers to see how jewelry looks on them.
              </span>
            </li>
            <li className="flex items-start">
              <span className="text-teal-600 text-xl mr-2">✔</span>
